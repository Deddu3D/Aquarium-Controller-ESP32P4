...
class PrefsRepository(context: Context) {
    ...
    /** Full HTTPS URL including port, e.g. "https://mioaqua.duckdns.org:443" */
    var espUrl: String?
    ...
    /** Build a full URL from domain and port. Port 443 is omitted from the URL. */
    companion object {
        ...
        fun buildUrl(domain: String, port: Int): String {
            ...
            return if (port == 443) "https://$fullDomain"
                   else "https://$fullDomain:$port"
        }
    }
}
