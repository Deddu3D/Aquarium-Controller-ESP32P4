 ...
 * Mounts a FAT-formatted microSD card via the SDMMC host peripheral and
 ...
 *
 * Configures the SDMMC host (slot 1), mounts the FAT filesystem at
 * /sdcard and creates the logs/ and config/ subdirectories if they
 * do not exist.
 *
